...
})({"4eh6R":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "0a4ef83b6ebabd4f";
"use strict";
...
},{}],"cTzWq":[function(require,module,exports,__globalThis) {
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    form.addEventListener('submit', function(event) {
        ...
        (0, _axiosDefault.default).post('http://localhost:8080/usuarios', {
            email,
            password
        }).then((response)=>{
            if (response.data.success) window.location.href = '/Frontend/Citas/citas.html'; // Redirigir si el login es exitoso
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["4eh6R","cTzWq"], "cTzWq", "parcelRequire94c2")

//# sourceMappingURL=index.6ebabd4f.js.map
